...
total_score = 0
interpretation = "N/A"
feedback_summary = "N/A"

if st.session_state.feedback_response:
    try:
        var = st.session_state.feedback_response
        if isinstance(var, str):
            feedback_response = json.loads(var)
        elif isinstance(var, dict):
            feedback_response = var
        ...
        interpretation = feedback_response.get("interpretation", "No interpretation available.") 
        feedback_summary = feedback_response.get("feedback_summary", "No summary available.")  
